...
- #545: Holding `Alt`/`Option` now temporarily bypasses cursor-stick post-processing for keyboard navigation and mouse placement, so you can place the caret inside bullet/checkbox markup without changing the setting.
